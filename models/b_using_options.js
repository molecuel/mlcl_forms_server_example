...
var BSchema = new Schema({
  ...
  file: {type: Schema.Types.Mixed, form: {type: 'file', widget: 'file'}},
  gallery: {type: Schema.Types.Mixed, form: {type: 'file', widget: 'gallery'}},
  ...
  dateOfBirth: {type: Date, form:{type: 'datetime', widget: 'datepicker'}},
  ...
  accessoires2: [{type: Schema.Types.ObjectId, ref: 'file'}],
  accessoires3: {
    file: {type: Schema.Types.ObjectId, ref: 'file'},
    title: {type: String}
  },
  accessoires4: [{
    file: { type: Schema.Types.ObjectId, ref: 'file'},
    title: {type: String},
    // this is a special type for object definitions
    mlcl_form: {type: Schema.Types.Mixed, form: {widget: 'file'}}
  }]
});
